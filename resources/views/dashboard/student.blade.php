                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="text-right">
                            ...
                            <p class="text-xs text-gray-500">{{ $user->role->name ?? 'Student' }}</p>
                        </div>
    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center py-20">
                ...
                <p class="text-gray-600 mb-8">Student dashboard coming soon. You'll be able to view your assignments, grades, attendance, and more.</p>
